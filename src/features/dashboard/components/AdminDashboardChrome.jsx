...
import { ADMIN_SECTIONS } from "@/features/dashboard/model/adminDashboardModel";
import styles from "./AdminDashboardChrome.module.css";

export function AdminSectionNav({ activeSection, setActiveSection }) {
  return (
...
export function AdminSectionDivider({ label, lucide: LucideComp }) {
  return (
